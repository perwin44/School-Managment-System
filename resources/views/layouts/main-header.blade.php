<!--=================================
header start-->
<nav class="admin-header navbar navbar-default col-lg-12 col-12 fixed-top d-flex flex-row p-0">
    <!-- logo -->
    ...
    <ul class="nav navbar-nav mr-auto">
        <li class="nav-item">
            <a id="button-toggle" class="button-toggle-nav pull-left inline-block ml-20" href="javascript:void(0);"><i class="zmdi zmdi-menu ti-align-right"></i></a>
        </li>
        <li class="nav-item">
            <div class="search">
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <div class="btn-group mb-1">
            <button type="button" class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                @if (App::getLocale() == 'ar')
                    ...
                    <img src="{{ URL::asset('assets/images/flags/sy.jfif') }}" style="width:23px ; height::33px;" alt="">
                @else
                    {{ LaravelLocalization::getCurrentLocaleName() }}
        ...
        <li class="nav-item dropdown ">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
                ...
                <a href="#" class="dropdown-item">New registered user <small class="text-muted time float-right">Just now</small> </a>
                <a href="#" class="dropdown-item">New invoice received <small class="text-muted time float-right">22 mins</small> </a>
                <a href="#" class="dropdown-item">Server error report<small class="text-muted time float-right">7 hrs</small> </a>
                <a href="#" class="dropdown-item">Database report<small class="text-muted time float-right">1
                        days</small> </a>
                <a href="#" class="dropdown-item">Order confirmation<small class="text-muted time float-right">2
                        days</small> </a>
            </div>
        </li>
        <li class="nav-item dropdown ">
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <form method="POST" action="{{ route('logout.student','student') }}">
                    @elseif(auth('teacher')->check())
                        <form method="POST" action="{{ route('logout.teacher','teacher') }}">
