...
class OnlineZoomClassesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Teachers.online_classes.index', compact('online_classes'));
    }
    ...
    {
        $Grades = Grade::all();
        return view('Teachers.online_classes.add', compact('Grades'));
    }

    public function indirectCreate()
    {
        $Grades = Grade::all();
        return view('Teachers.online_classes.indirect', compact('Grades'));
    }
